node {
    ...
    stage('Deploy Docker Image and login'){
      ...
      echo "Docker Image Tag Name: ${dockerImageTag}"
        ...
        sh "docker images"
        sh "docker login -u surya23tiwari -p Docker@123" // put PWD
	...
	//sh "read imageid"
	   sh "docker tag 0253c81dce5f  surya23tiwari/myapplication" //must change your name and tag no
        sh "docker push   surya23tiwari/myapplication"
  }
}
